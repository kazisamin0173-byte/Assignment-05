...
function buttonInactive(buttonId) {
    ...
    const filterData = allDataCard.filter(problem => problem.status === "open")
...
if(problem.status === "closed"){
    ...
    priorityClass = "bg-[#EEEFF2] text-[#9CA3AF]";
        ...
        card.innerHTML = `
        <div onclick="openModal(${problem.id})" id="ItemDesign" class="p-4 card shadow-2xl border-t-4 ${cardBorderClass} flex flex-col h-full">
                   ...
                   <div class="space-y-4 flex flex-col grow">
                        <div>
                      ...
                      <div class="flex flex-wrap gap-2 labels-container min-h-10">
